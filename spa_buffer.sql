...
--
  ...
  DBMS_SQLPA.EXECUTE_ANALYSIS_TASK( 
     task_name => 'UPGRADE_TO_19C_3', 
     execution_name => 'EXEC_SPA_TASK_19C_3', 
     execution_type => 'TEST EXECUTE', 
     execution_desc => 'Test 11204 Workload in 19c'); 

--
-- Compare performance before/after on BUFFER_GETS
--


   DBMS_SQLPA.EXECUTE_ANALYSIS_TASK( 
     task_name => 'UPGRADE_TO_19C_3', 
     execution_name => 'Compare 11204 to 19c BUFFER_GETS', 
     ...
     execution_params => 
       DBMS_ADVISOR.ARGLIST( 
               ...
               'execution_name2','EXEC_SPA_TASK_19C_3'), 
     execution_desc => 'Compare 11204 to 19c BUFFER_GETS'
     ); 
